...
INSTRUCTIONS: list[tuple[str, list[str]]] = [
    ("Objective & Scoring", [
        ...
        "Eating a PacGum earns 10 points.",
        "Eating a Super PacGum earns 50 points and makes ghosts vulnerable.",
        "Eating an edible ghost earns 200 points.",
        "You start with 3 lives. Survive all 10 levels to win.",
        "Each level has a time limit — keep an eye on the timer!",
    ]),
    ("Super PacGums & Ghosts", [
        ...
        "Move into a blue ghost to eat it for 200 points.",
...
class InstructionsState(GameState):
    ...
    def render(self, screen):
        ...
        for section_title, bullets in INSTRUCTIONS:
